"""Import-smoke + pure-function tests for africa-rct-e156-portfolio (Bucket-B no-tests remediation).
...
_SCRIPT = os.path.join(
    ...
    'scripts', 'render_portfolio_assets.py')


def _load():
    sys.path.insert(0, os.path.dirname(_SCRIPT))
    spec = importlib.util.spec_from_file_location("buildmod_africa_rct_e156_portfolio", _SCRIPT)
